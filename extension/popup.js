...
(async function init() {
    ...
    async function handleExport() {
        ...
        try {
            ...
            if (importProgressEl) importProgressEl.textContent = `Importing ${folders.length} folders, ${bookmarks.length} bookmarks...`;
            if (statusEl) statusEl.textContent = `Found ${bookmarks.length} bookmarks. Importing...`;
            ...
            if (importProgressEl) importProgressEl.textContent = 'Check the website to see metadata enrichment in progress.';
