...
function sortFoldersTopologically(folders: FolderInput[]): FolderInput[] {
...
async function createFolderMap(
  ...
  for (const folder of sorted) {
    const appParentId = folder.parentId ? map.get(folder.parentId) : undefined;
