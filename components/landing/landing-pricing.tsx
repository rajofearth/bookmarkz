    ...
    >
      <div className="absolute inset-0 z-0" aria-hidden>
        <Image
          ...
          alt=""
          fill
          className={LANDING_SCENIC_IMAGE_CLASS}
          sizes="100vw"
          priority={false}
        />
      </div>
      <div
        ...
        aria-hidden
      />
      <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center text-center rounded-2xl px-8 py-10 sm:px-10 sm:py-12 bg-background/82 backdrop-blur-md border border-border/50 shadow-xl shadow-black/5 dark:bg-background/70">
        <motion.h2
